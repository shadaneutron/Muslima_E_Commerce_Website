            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <Input id="name" value={customerInfo.name} onChange={(e) => handleInputChange('name', e.target.value)} required className="bg-white text-stone-900 placeholder:text-stone-500 border-stone-300" />
                </div>
                <div>
                  <Label htmlFor="email" className="text-stone-800">{t('checkout.email')}</Label>
                  <Input id="email" type="email" value={customerInfo.email} onChange={(e) => handleInputChange('email', e.target.value)} required className="bg-white text-stone-900 placeholder:text-stone-500 border-stone-300" />
                </div>
                <div>
                  <Label htmlFor="phone" className="text-stone-800">{t('checkout.phone')}</Label>
                  <Input id="phone" value={customerInfo.phone} onChange={(e) => handleInputChange('phone', e.target.value)} required className="bg-white text-stone-900 placeholder:text-stone-500 border-stone-300" />
                </div>
                <div>
                  <Label htmlFor="address" className="text-stone-800">{t('checkout.address')}</Label>
                  <Input id="address" value={customerInfo.address} onChange={(e) => handleInputChange('address', e.target.value)} required className="bg-white text-stone-900 placeholder:text-stone-500 border-stone-300" />
                </div>
                <div>
                  <Label htmlFor="city" className="text-stone-800">{t('checkout.city')}</Label>
                  <Input id="city" value={customerInfo.city} onChange={(e) => handleInputChange('city', e.target.value)} required className="bg-white text-stone-900 placeholder:text-stone-500 border-stone-300" />
                </div>
              </div>
