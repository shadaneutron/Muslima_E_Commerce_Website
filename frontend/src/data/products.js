export const products = [
  ...
  {
    id: '3',
    name: { ar: 'عباءة كيمونو عصرية', en: 'Modern Kimono Abaya' },
    description: {
  ...
  {
    id: '4',
    name: { ar: 'حجاب حريري فاخر', en: 'Luxury Silk Hijab' },
    description: {
  ...
  {
    id: '5',
    name: { ar: 'عباءة بأكمام واسعة', en: 'Wide Sleeve Abaya' },
    description: {
  ...
  {
    id: '6',
    name: { ar: 'جلباب للمناسبات', en: 'Occasion Jilbab' },
    description: {
